...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getLocations = function () {
        var _this = this;
        this.locationService.getLocation().subscribe(function (data) { _this.mfLocation = data[0]; }, function (err) { return console.error(err); }, function () { return console.log('done loading locations', _this.mfLocation); });
    };
    AppComponent.prototype.onPhoneClicked = function (e) {
...
/* harmony import */ var widgettest_dist_loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! widgettest/dist/loader */ "./node_modules/widgettest/dist/loader/index.mjs");
